...
@Entity
@Table(name = ContextPathEurekaServiceMappingEntity.CONTEXT_SERVICE_MAPPING_TABLE_NAME)
...
public class ContextPathEurekaServiceMappingEntity implements Serializable {
    ...
    @SequenceGenerator(name="ctx_svc_generator", sequenceName = ContextPathEurekaServiceMappingEntity.CONTEXT_SERVICE_MAPPING_SEQUENCE_NAME)
    private Long id;
    ...
    @JoinColumn(name = "EUREKA_SERVICE_STATUS.ID")
